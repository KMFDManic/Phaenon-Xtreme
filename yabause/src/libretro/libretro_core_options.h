...
struct retro_core_option_v2_definition option_defs_us[] = {
  ...
  NULL,
   ...
   {
   "yabause_crop_lr_pixels",
   "Crop L/R For Speed",
   "Cut pixels from the left and right edges. Higher values = more performance, less visible width.",
   NULL,
   NULL,
   NULL,
   {
   ...
   {
   "yabause_crop_tb_pixels",
   "Crop T/B For Speed",
   "Cut pixels from the top and bottom edges. Removes letterbox and status bars to reduce work.",
   NULL,
   NULL,
   NULL,
   {
